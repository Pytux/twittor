...
func UploadBanner(w http.ResponseWriter, r *http.Request) {
	...
	var fileName string = "uploads/banner/" + UserID + "." + ext
	...
	if err != nil {
		http.Error(w, "Error, can't copy banner. "+err.Error(), http.StatusBadRequest)
		return
	}
	...
	if err2 != nil || !status {
		http.Error(w, "Error, can't save banner. "+err2.Error(), http.StatusBadRequest)
		return
	}
